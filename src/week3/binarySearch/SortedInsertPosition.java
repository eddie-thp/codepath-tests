...
public class SortedInsertPosition {
	...
	public int searchInsert(ArrayList<Integer> a, int b) {
        ...
        while (start <= end) {
            ...
            int val = a.get(middleIndex);

            System.out.println("Middle (" + middleIndex + ") : " + val);
